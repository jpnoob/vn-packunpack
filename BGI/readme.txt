...
bgi version 1.546.7 - compatibility v1.69 (daitoshokan trial)
...
bgi version 1.575 - compatibility v1.71 (fureraba trial)
-------------------------------------------------------------------------------
...
TODO add support for actual linebreaks (0d 0a) in encoded files, convert to
"\n" in .txt dump
-------------------------------------------------------------------------------
